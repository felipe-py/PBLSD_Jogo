...
//COLLISION
    for(y=26; y<=33; y++){
        for(x=14; x<=64; x++){
            ...
            (y == 26 && ((x >= 14 && x <= 18) || (x >= 20 && x <= 24) || (x >= 26 && x <= 27) || (x >= 32 && x <= 33) || (x >= 38 && x <= 41) || 
                (x >= 43 && x <= 47) || (x >= 49 && x <= 52) || (x >= 54 && x <= 58) || (x >= 60 && x <= 61) || x == 64)) ||
    ...
    edit_bloco_background_wbm(65, 26, 0, 3, 5);
    edit_bloco_background_wbm(65, 27, 0, 3, 5);
    edit_bloco_background_wbm(65, 28, 0, 3, 5);
    edit_bloco_background_wbm(65, 29, 0, 3, 5);
    edit_bloco_background_wbm(65, 30, 0, 3, 5);
    edit_bloco_background_wbm(65, 31, 0, 3, 5);
    edit_bloco_background_wbm(65, 32, 0, 3, 5);
    edit_bloco_background_wbm(65, 33, 0, 3, 5);
...
//-----------------------------------------------------------------------------------------------------------------------//
    ...
    for(x=0; x<80; x++){
        for(y=0; y<60; y++){
            desabilita_bloco_background_wbm(x,y);
        }
    }
    ...
    for (x = 0; x < 16; ++x) {
        if (set_quadrado_dp(0, 0, 0, 0, 0, 0, x) == -1) {
            break; 
        }
    }*/
